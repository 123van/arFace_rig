...
def arFace_ctlList():
    ...
    browCtl =[u'brow_arcMid', u'brow_arcRA', u'brow_arcLB', u'brow_arcRB', u'brow_arcLA', u'brow_arcLC', u'brow_arcRC', u'brow_arcRD', u'l_browUD_ctl', u'l_madSad_ctl',
    u'r_browUD_ctl', u'r_madSad_ctl', u'brow_arcLD', u'brow_arcRE', u'brow_arcLE', u'r_brow11_ctl', u'r_brow10_ctl'] 
    eyeCtl = ['r_offset_ctl','r_eyeDir_ctl','r_lidScale_ctl','l_offset_ctl','l_eyeDir_ctl','r_doubleLid_ctl','r_eyeOpen_ctl','r_eyeSquint_ctl',
    'l_eyeSquint_ctl','l_lidScale_ctl','l_eyeOpen_ctl','l_doubleLid_ctl','eyeAim_ctlTop1|eyeAim_ctl']
    mouthCtl = [u'l_phoneme_ctl', u'l_happySad_ctl', u'l_lipCorner_ctl', u'l_lo_ShM_ctl', u'r_happySad_ctl', u'r_phoneme_ctl', u'l_up_ShM_ctl', u'r_lipCorner_ctl',
    u'r_up_ShM_ctl', u'r_lo_ShM_ctl', u'loteeth_motion_ctl', u'upteeth_motion_ctl', u'jawOpen_ctl', u'mouthMove_ctl', u'swivel_ctl', u'jawDrop_ctl', ]
    bridgeCtl = [u'l_puffsuck', u'r_puffsuck', u'l_flareSneer_ctl', u'r_flareSneer_ctl', u'nose_onCtl', u'l_ear_onCtl', u'r_ear_onCtl', u'r_squintPuff_onCtl',
    u'l_squintPuff_onCtl', u'r_lowCheek_onCtl', u'l_lowCheek_onCtl', u'l_cheek_onCtl', u'r_cheek_onCtl']
...
#select driver( head_ctl or locator ) and ctl_grps
#to match rotation order, create locator(driver) and parent to driver   
def connect_ctlRotate_toBody( ):
    mySel = cmds.ls(sl=1)
    driverCtl = mySel[0]
    ctlGrps = mySel[1:] 
    ...
    #if 
    for grp in ctlGrps:
        ctlPrnts = cmds.listRelatives( grp, c=1, typ = "transform" )#get "ctl_parents" that are attatch to head        
        #ctl_grp
        for ctl in ctlPrnts :  
            
            cmds.connectAttr( DCM + ".outputRotateX",  ctl + ".rotateX" )
            cmds.connectAttr( DCM + ".outputRotateY",  ctl + ".rotateY" )
            cmds.connectAttr( DCM + ".outputRotateZ",  ctl + ".rotateZ" )
