...
def browCrvCtlToJnt (browCtrl, browDetail, jnt, ctlGrp, madPOC, POC, initialMadX, initialX, RotateScale, index ):        
    ...
    cmds.connectAttr ( crvMult + ".outputX", ctlGrp + '.ry')
    cmds.connectAttr ( crvMult + ".outputY", ctlGrp + '.rx')
    #X total
